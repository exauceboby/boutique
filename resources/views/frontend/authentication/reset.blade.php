...
<head>
    ...
    <title>
        Réinitialisation du mot de passe | {{ readConfig('site_name') }}
    </title>
    <!-- FAVICON ICON -->
...
<body>
    ...
    <section class="authentications">
        <div class="left-content">
            <figure>
                <img src="{{ asset('assets/images/authentication/login.svg') }}" alt="image de vérification OTP">
            </figure>
        </div>
        <div class="right-content">
            <form action="{{ route('password.reset') }}" method="post" class="authentication-form px-lg-5 forgot-form">
                ...
                <div class="authentication-form-header">
                    ...
                    <p class="form-des">Veuillez saisir le code que nous vous avons envoyé par email.</p>
                </div>
                ...
                <div class="authentication-form-footer">
                    <p>Vous n'avez pas reçu l'email ? Cliquez pour <a href="{{ route('resend.otp') }}">renvoyer</a></p>
