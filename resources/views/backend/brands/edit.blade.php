...
@section('title', 'Mettre à jour la marque')
      ...
      <div class="card-body">
        <div class="row">
          ...
          <div class="mb-3 col-md-6">
            ...
            <div class="image-upload-container" id="imageUploadContainer">
              ...
              <div class="thumb-preview" id="thumbPreviewContainer">
                <img src="{{ asset('storage/' . $brand->image) }}" alt="Aperçu de l'image"
          ...
          <div class="mb-3 col-md-12">
            ...
            <textarea class="form-control" placeholder="Entrer la description" name="description">{{ old('description',$brand->description) }}</textarea>
          </div>
